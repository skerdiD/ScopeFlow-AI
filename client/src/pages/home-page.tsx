  ...
  return (
    <div className="min-h-screen bg-[#f6f8fc] text-slate-900">
      <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link to="/" className="inline-flex items-center gap-2.5">
            ...
            <span className="text-sm font-semibold tracking-tight">ScopeFlow AI</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <Button asChild size="sm" className="h-9 rounded-xl bg-slate-900 text-white hover:bg-slate-800">
      ...
      <section className="relative overflow-hidden border-b border-slate-200/80">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_15%_18%,rgba(59,130,246,0.18),transparent_30%),radial-gradient(circle_at_85%_10%,rgba(14,165,233,0.16),transparent_30%),radial-gradient(circle_at_88%_82%,rgba(99,102,241,0.15),transparent_26%)]" />
        <div className="mx-auto grid w-full max-w-7xl items-center gap-14 px-4 pb-20 pt-14 sm:px-6 lg:grid-cols-[minmax(0,1.03fr)_minmax(0,0.97fr)] lg:px-8 lg:pb-24 lg:pt-20">
          <FadeUp className="relative max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/90 px-3 py-1.5 text-xs font-medium text-slate-700 shadow-sm">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <Button asChild size="lg" className="h-12 rounded-xl bg-slate-900 px-6 text-white hover:bg-slate-800">
                <Link to={user ? "/dashboard" : "/signup"}>
                  {user ? "Open workspace" : "Generate proposal"}
                  <ArrowRight className="size-4" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="h-12 rounded-xl border-slate-300 px-6">
          ...
          <FadeUp delay={100} className="relative">
            <Card className="overflow-hidden rounded-[2rem] border-slate-200 bg-white shadow-[0_35px_110px_-46px_rgba(15,23,42,0.55)]">
              <CardContent className="p-0">
                ...
                <div className="grid gap-3 p-3 lg:grid-cols-[210px_1fr]">
                  <div className="rounded-2xl border border-slate-200 bg-white p-3">
                    <p className="text-xs font-medium uppercase tracking-[0.14em] text-slate-500">Sections</p>
                    {[
                      "Executive summary",
                      "Scope of work",
                      "Deliverables",
                      ...
                      <div
                        key={section}
                        className="mt-2 flex items-center justify-between rounded-lg bg-slate-50 px-2 py-1.5 text-xs text-slate-700"
                      >
                        {section}
                  ...
                  <div className="space-y-3">
                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                      ...
                      <p className="mt-2 text-xs text-slate-600">AI structured timelines and dependency risks.</p>
                      <div className="mt-3 h-2 rounded-full bg-slate-100">
                        <div className="h-2 w-[84%] rounded-full bg-gradient-to-r from-indigo-500 to-sky-500" />
                      </div>
                    </div>
            ...
            <div className="absolute -left-5 top-10 hidden rounded-2xl border border-slate-200 bg-white px-3 py-2 text-xs shadow-md sm:block">
      ...
      <section id="problem" className="border-b border-slate-200/80 bg-slate-100/70 py-24 sm:py-28">
            ...
            {problemCards.map((item, index) => {
              ...
              return (
                <FadeUp key={item.title} delay={index * 90}>
                  <Card className="h-full rounded-3xl border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <section id="solution" className="py-24 sm:py-28">
        <div className="mx-auto grid w-full max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-14 lg:px-8">
          <FadeUp>
            <p className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.08em] text-sky-700">
          ...
          <FadeUp delay={120}>
            <Card className="rounded-[2rem] border-slate-200 bg-white p-1 shadow-[0_26px_80px_-42px_rgba(15,23,42,0.45)]">
              <CardContent className="rounded-[1.4rem] border border-slate-200 bg-slate-50 p-4">
                <div className="rounded-xl border border-slate-200 bg-white p-4">
                  <p className="text-xs text-slate-500">Raw discovery notes</p>
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-4">
                  <p className="text-xs text-slate-500">ScopeFlow AI output</p>
                  {["Executive summary", "Scope and deliverables", "Milestones", "Risk analysis"].map((item) => (
                    <div
                      key={item}
                      className="mt-2 flex items-center justify-between rounded-lg bg-slate-50 px-3 py-2 text-xs text-slate-700"
                    >
                      {item}
      ...
      <section id="features" className="border-y border-slate-200/80 bg-white py-24 sm:py-28">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionIntro
            eyebrow="Features"
            ...
            {featureCards.map((feature, index) => {
              ...
              return (
                <FadeUp key={feature.title} delay={index * 90}>
                  <Card className="h-full rounded-3xl border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                    <CardContent className="p-6">
                      <span
                        className={cn(
                      ...
                      <p className="mt-5 inline-flex items-center gap-1 text-sm font-medium text-indigo-700">
                        Learn more
      ...
      <section id="product-preview" className="bg-slate-50 py-24 sm:py-28">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionIntro
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
            <FadeUp>
              <Card className="overflow-hidden rounded-[2rem] border-slate-200 bg-white shadow-[0_30px_100px_-44px_rgba(15,23,42,0.5)]">
                <CardContent className="p-0">
                  ...
                  <div className="grid gap-4 p-5 lg:grid-cols-2">
                    <div className="space-y-3">
                      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <p className="mt-2 text-xs text-slate-600">AI-generated overview aligned to client outcomes.</p>
                      </div>
                      <div className="rounded-2xl border border-slate-200 bg-white p-4">
                        ...
                        {["UX audit and IA", "Design system", "CMS handoff"].map((item) => (
                          <div
                            key={item}
                            className="mt-2 flex items-center gap-2 rounded-lg bg-slate-50 px-3 py-2 text-xs text-slate-600"
                          >
                    ...
                    <div className="space-y-3">
                      <div className="rounded-2xl border border-slate-200 bg-white p-4">
                        <p className="text-xs font-medium uppercase tracking-[0.12em] text-slate-500">AI insights</p>
                      ...
                      <div className="rounded-2xl border border-slate-200 bg-white p-4">
                        <p className="text-xs font-medium uppercase tracking-[0.12em] text-slate-500">Version history</p>
                ...
                return (
                  <FadeUp key={item.title} delay={index * 90}>
                    <Card className="rounded-3xl border-slate-200 bg-white shadow-sm">
                      <CardContent className="p-6">
                        <span className="inline-flex size-10 items-center justify-center rounded-2xl bg-slate-900 text-white">
                          <Icon className="size-4" />
                        </span>
                        <h3 className="mt-4 text-lg font-semibold tracking-tight">{item.title}</h3>
      ...
      <section id="testimonials" className="border-y border-slate-200/80 bg-white py-24 sm:py-28">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionIntro
          ...
          <div className="mt-10 grid gap-4 rounded-3xl border border-slate-200 bg-slate-50/70 p-6 sm:grid-cols-2 lg:grid-cols-4">
